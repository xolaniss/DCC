...
library(zoo)
library(tidyverse)
setwd("/Users/xolanisibande/DCC/CME_hong_tests/cme_variance, daily_infect_emv_index_7")
rm(list=ls())
...
results$date <- as.yearmon(data$date[-c(1:6)],  format = "%Y-%m-%d")
